...
let Chaincode = class {
   ...
   * }
   */
  async createFileRecord(stub, args) {
    console.log('============= START : createFileRecord ===========');
    console.log('##### createFileRecord arguments: ' + JSON.stringify(args));

    // args is passed as a JSON string
    let json = JSON.parse(args);
    let key = json['fileName'];
    json['docType'] = 'file';

    console.log('##### createFileRecord payload: ' + JSON.stringify(json));

    // Check if the file already exists
    let donorQuery = await stub.getState(key);
    if (donorQuery.toString()) {
      throw new Error('##### createFileRecord - This file already exists: ' + json['fileName']);
    }

    await stub.putState(key, Buffer.from(JSON.stringify(json)));
    console.log('============= END : createFileRecord ===========');
  }
   ...
   * @param {*} args 
   */
  async queryFileRecord(stub, args) {
    console.log('============= START : queryFileRecord ===========');
    console.log('##### queryFileRecord arguments: ' + JSON.stringify(args));

    // args is passed as a JSON string
    let json = JSON.parse(args);
    let key = json['fileName'];
    console.log('##### queryFileRecord key: ' + key);
   ...
   * @param {*} args 
   */
  async queryAllFileRecords(stub, args) {
    console.log('============= START : queryAllFileRecords ===========');
    console.log('##### queryAllFileRecords arguments: ' + JSON.stringify(args));
 
    let queryString = '{"selector": {"docType": "file"}}';
